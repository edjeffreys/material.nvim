...
M.main_highlights.treesitter = function()
	if vim.fn.has("nvim-0.8.0") == 1 then
		local treesitter_hls = {
			...
			["@comment"] = { fg = s.comments },
			["@conditional.ternary"] = { fg = m.cyan },
			["@delimiter"] = { fg = m.cyan },
			["@exception"] = { fg = m.purple },
			-- ["@field"]                 = { fg = m.white },
			["@function"] = { fg = m.blue },
			["@function.macro"] = { fg = m.paleblue },
			["@operator"] = { fg = m.cyan },
			...
			["@string"] = { fg = m.green },
			-- ["@type"]                  = { fg = m.yellow },
			["@type.qualifier"] = { fg = m.purple },
			["@variable"] = { fg = m.white },
			["@variable.builtin"] = { fg = m.purple },
			["@variable.type"] = { fg = m.yellow },
		}
...
M.async_highlights.load_lsp = function()
	local lsp_hls = {
		...
		["@lsp.type.parameter"] = { fg = m.orange },
		["@lsp.type.property"] = { fg = m.white },
		["@lsp.type.variable"] = { fg = m.white },
